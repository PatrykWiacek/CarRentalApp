...
namespace RestApiNDApplication1.Api.Controllers.v1
{
    [ApiVersion("1.0")]
    ...
    public class InfoController : ControllerBase
    {
        ...
        public IActionResult ApiInfo()
        {
            ...
            var connstring = Configuration["ConnectionStrings:RestApiNDApplication1DB"];
            ...
            return Content("<html><head><link href='https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css' rel='stylesheet' integrity='sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh' crossorigin='anonymous'></head><body>" +
                ...
                "<div class='jumbotron'>" +
                "<h1><i class='fab fa-centercode' fa-2x></i>  RestApiNDApplication1 Api v.1</h1>" +
                "<h4>Created with RestApiND v.6.0.0 with Dapper ORM</h4>" +
                 ...
                 "<li>Logs location: RestApiNDApplication1.Api\\Logs</li></ul>" +
                 "<a class='btn btn-outline-warning' role='button' href='https://www.anasoft.net/restapidapper'><b>More instructions and more features</b></a>" +
                 "<a class='btn btn-outline-warning' role='button' href='https://www.anasoft.net/restapidapper/video'><b>YouTube instructions</b></a>" +
                "</div>" +
...
namespace RestApiNDApplication1.Api.Controllers.v2
{
    [ApiVersion("2.0")]
    [Route("api/v{version:apiVersion}/[controller]")]
    [ApiController]
    public class InfoController : ControllerBase
    {
        ...
        public IActionResult ApiInfo()
        {
            ...
            return Content("<html><head><link rel='stylesheet' href='https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.2/css/bootstrap.min.css' integrity='sha384-PsH8R72JQ3SOdhVi3uxftmaW6Vc51MKb0q5P2rRUpPvrszuE4W1povHYgTpBfshb' crossorigin='anonymous'><link rel='stylesheet' href='https://use.fontawesome.com/releases/v5.3.1/css/all.css' integrity='sha384-mzrmE5qonljUremFsqc01SB46JvROS7bZs3IO2EmfFsd15uHvIt+Y8vEf7N7fWAU' crossorigin='anonymous'></head><body>" +
                ...
                "<div class='jumbotron'>" +
                "<h1><i class='fab fa-centercode' fa-2x></i>  RestApiNDApplication1 Api v.2</h1>" +
                "<h4>Created with RestApiND v.5.0.0</h4>" +
                 "REST Api service started!<br>" +
                 "appsettings.json configuration:<br>" +
                 "<ul><li>.NET 5.0</li>" +
                 "<li>Use Migration Service: " + migration + "</li>" +
