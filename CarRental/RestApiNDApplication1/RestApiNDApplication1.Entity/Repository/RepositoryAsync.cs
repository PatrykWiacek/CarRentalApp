...
namespace RestApiNDApplication1.Entity.Repository;
/// <summary>
...
public class RepositoryAsync<T> : IRepositoryAsync<T> where T : class
{
    ...
    private RestApiNDApplication1Context _context;
    ...
    public RepositoryAsync(RestApiNDApplication1Context dbProvider)
    {
